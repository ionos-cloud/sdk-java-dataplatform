...
# **createCluster**
> ClusterResponseData createCluster(createClusterRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ClusterResponseData result = apiInstance.createCluster(createClusterRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DataPlatformClusterApi#createCluster");
...
# **deleteCluster**
> ClusterResponseData deleteCluster(clusterId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ClusterResponseData result = apiInstance.deleteCluster(clusterId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DataPlatformClusterApi#deleteCluster");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getCluster"></a>
# **getCluster**
> ClusterResponseData getCluster(clusterId)
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID clusterId = new UUID(); // UUID | The unique ID of the cluster. Must conform to the UUID format. 
    try {
      ClusterResponseData result = apiInstance.getCluster(clusterId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DataPlatformClusterApi#getCluster");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling DataPlatformClusterApi#getClusterKubeconfig");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **getClusters**
> ClusterListResponseData getClusters(name)
...
public class Example {
  public static void main(String[] args) {
    ...
    DataPlatformClusterApi apiInstance = new DataPlatformClusterApi(defaultClient);
    String name = "name_example"; // String | Response filter to list only the clusters which include the specified name. The value is case insensitive and matched on the `name` property of the cluster. The input is limited to 63 characters with alphanumeric character ([a-z0-9A-Z]) dashes (-), underscores (_), dots (.), and alphanumerics allowed. 
    try {
      ClusterListResponseData result = apiInstance.getClusters(name);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DataPlatformClusterApi#getClusters");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="patchCluster"></a>
# **patchCluster**
> ClusterResponseData patchCluster(clusterId, patchClusterRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ClusterResponseData result = apiInstance.patchCluster(clusterId, patchClusterRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DataPlatformClusterApi#patchCluster");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
