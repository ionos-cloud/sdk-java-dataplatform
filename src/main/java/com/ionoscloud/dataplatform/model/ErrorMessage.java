...
public class ErrorMessage {
  ...
  **/
  ...
  @ApiModelProperty(example = "dsaas-err-api-4711", value = "internal error code ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example error message", value = "A human readable explanation of the problem. ")
