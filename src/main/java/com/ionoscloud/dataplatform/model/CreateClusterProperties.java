...
public class CreateClusterProperties {
  ...
  public CreateClusterProperties name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "my-cluster", required = true, value = "The name of your cluster. Must be 63 characters or less and must begin and end with an alphanumeric character ([a-z0-9A-Z]) with dashes (-), underscores (_), dots (.), and alphanumerics between. ")
  ...
  public CreateClusterProperties dataPlatformVersion(String dataPlatformVersion) {
  ...
  **/
  ...
  public CreateClusterProperties datacenterId(UUID datacenterId) {
   ...
   * @return datacenterId
  **/
  @ApiModelProperty(required = true, value = "The UUID of the virtual data center (VDC) the cluster is provisioned. ")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createClusterProperties.name) && Objects.equals(this.dataPlatformVersion, createClusterProperties.dataPlatformVersion) && Objects.equals(this.datacenterId, createClusterProperties.datacenterId) && Objects.equals(this.maintenanceWindow, createClusterProperties.maintenanceWindow);
  }
