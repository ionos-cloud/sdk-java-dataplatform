...
import com.ionoscloud.dataplatform.model.Cluster;
 ...
 * Data of a cluster
 */
@ApiModel(description = "Data of a cluster")
...
public class ClusterResponseData {
  ...
  public ClusterResponseData id(UUID id) {
  ...
  **/
  ...
  public ClusterResponseData type(String type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "cluster", value = "The type of the resource.")
  ...
  public ClusterResponseData href(String href) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://api.ionos.com/dataplatform/v1/clusters/498ae72f-411f-11eb-9d07-046c59cc737e", value = "URL to the object representation (absolute path).")
  ...
  public ClusterResponseData metadata(Metadata metadata) {
  ...
  **/
  ...
  public ClusterResponseData properties(Cluster properties) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ClusterResponseData clusterResponseData = (ClusterResponseData) o;
    return Objects.equals(this.id, clusterResponseData.id) && Objects.equals(this.type, clusterResponseData.type) && Objects.equals(this.href, clusterResponseData.href) && Objects.equals(this.metadata, clusterResponseData.metadata) && Objects.equals(this.properties, clusterResponseData.properties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterResponseData {\n");
