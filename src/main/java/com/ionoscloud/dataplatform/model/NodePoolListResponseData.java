 ...
 */
@ApiModel(description = "Data of a node pool list")
...
public class NodePoolListResponseData {
  ...
  private List<NodePoolResponseData> items = new ArrayList<NodePoolResponseData>();

  

  public NodePoolListResponseData id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "dataplatform/clusters", value = "The ID of a list of resources. ")
  ...
  public NodePoolListResponseData type(String type) {
  ...
  **/
  ...
  public NodePoolListResponseData href(String href) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://.../clusters/.../nodepools", value = "")
  ...
  public NodePoolListResponseData items(List<NodePoolResponseData> items) {
    
    this.items = items;
    return this;
  }

  public NodePoolListResponseData addItemsItem(NodePoolResponseData itemsItem) {
  ...
  **/
  ...
  public List<NodePoolResponseData> getItems() {
    return items;
  }


  public void setItems(List<NodePoolResponseData> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    NodePoolListResponseData nodePoolListResponseData = (NodePoolListResponseData) o;
    return Objects.equals(this.id, nodePoolListResponseData.id) && Objects.equals(this.type, nodePoolListResponseData.type) && Objects.equals(this.href, nodePoolListResponseData.href) && Objects.equals(this.items, nodePoolListResponseData.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodePoolListResponseData {\n");
