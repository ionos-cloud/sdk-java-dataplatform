 ...
 */
@ApiModel(description = "Data of a cluster list")
...
public class ClusterListResponseData {
  ...
  private List<ClusterResponseData> items = new ArrayList<ClusterResponseData>();

  

  public ClusterListResponseData id(String id) {
  ...
  **/
  ...
  public ClusterListResponseData type(String type) {
  ...
  **/
  ...
  public ClusterListResponseData href(String href) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://.../clusters", value = "")
  ...
  public ClusterListResponseData items(List<ClusterResponseData> items) {
    
    this.items = items;
    return this;
  }

  public ClusterListResponseData addItemsItem(ClusterResponseData itemsItem) {
  ...
  **/
  ...
  public List<ClusterResponseData> getItems() {
    return items;
  }


  public void setItems(List<ClusterResponseData> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClusterListResponseData clusterListResponseData = (ClusterListResponseData) o;
    return Objects.equals(this.id, clusterListResponseData.id) && Objects.equals(this.type, clusterListResponseData.type) && Objects.equals(this.href, clusterListResponseData.href) && Objects.equals(this.items, clusterListResponseData.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterListResponseData {\n");
