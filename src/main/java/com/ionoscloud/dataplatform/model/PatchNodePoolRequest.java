...
import com.ionoscloud.dataplatform.model.PatchNodePoolProperties;
 ...
 */
@ApiModel(description = "Data to update selected properties of a node pool for a DataPlatformNodePool.")
...
public class PatchNodePoolRequest {
  ...
  private PatchNodePoolProperties properties;

  

  public PatchNodePoolRequest properties(PatchNodePoolProperties properties) {
  ...
  **/
  ...
  public PatchNodePoolProperties getProperties() {
    return properties;
  }


  public void setProperties(PatchNodePoolProperties properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(Object o) {
    ...
    PatchNodePoolRequest patchNodePoolRequest = (PatchNodePoolRequest) o;
    return Objects.equals(this.properties, patchNodePoolRequest.properties);
  }
