...
public class CreateNodePoolProperties {
  ...
  public CreateNodePoolProperties name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "my-node-pool", required = true, value = "The name of your node pool. Must be 63 characters or less and must begin and end with an alphanumeric character ([a-z0-9A-Z]) with dashes (-), underscores (_), dots (.), and alphanumerics between. ")
  ...
  public CreateNodePoolProperties nodeCount(Integer nodeCount) {
  ...
  **/
  ...
  public CreateNodePoolProperties cpuFamily(String cpuFamily) {
  ...
  **/
  ...
  @ApiModelProperty(example = "AUTO", value = "A valid CPU family name or `AUTO` if the platform shall choose the best fitting option. Available CPU architectures can be retrieved from the data center resource. ")
  ...
  public CreateNodePoolProperties coresCount(Integer coresCount) {
  ...
  **/
  ...
  public CreateNodePoolProperties ramSize(Integer ramSize) {
  ...
  **/
  ...
  public CreateNodePoolProperties availabilityZone(AvailabilityZone availabilityZone) {
  ...
  **/
  ...
  public CreateNodePoolProperties storageType(StorageType storageType) {
  ...
  **/
  ...
  public CreateNodePoolProperties storageSize(Integer storageSize) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "20", value = "The size of the volume in GB. The size must be greater than 10 GB.")
  ...
  public CreateNodePoolProperties maintenanceWindow(MaintenanceWindow maintenanceWindow) {
  ...
  **/
  ...
  public CreateNodePoolProperties labels(Object labels) {
  ...
  **/
  ...
  public CreateNodePoolProperties annotations(Object annotations) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateNodePoolProperties createNodePoolProperties = (CreateNodePoolProperties) o;
    return Objects.equals(this.name, createNodePoolProperties.name) && Objects.equals(this.nodeCount, createNodePoolProperties.nodeCount) && Objects.equals(this.cpuFamily, createNodePoolProperties.cpuFamily) && Objects.equals(this.coresCount, createNodePoolProperties.coresCount) && Objects.equals(this.ramSize, createNodePoolProperties.ramSize) && Objects.equals(this.availabilityZone, createNodePoolProperties.availabilityZone) && Objects.equals(this.storageType, createNodePoolProperties.storageType) && Objects.equals(this.storageSize, createNodePoolProperties.storageSize) && Objects.equals(this.maintenanceWindow, createNodePoolProperties.maintenanceWindow) && Objects.equals(this.labels, createNodePoolProperties.labels) && Objects.equals(this.annotations, createNodePoolProperties.annotations);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNodePoolProperties {\n");
