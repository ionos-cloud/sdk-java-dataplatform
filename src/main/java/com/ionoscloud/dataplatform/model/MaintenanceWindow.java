 ...
 */
@ApiModel(description = "Starting time of a weekly 4 hour-long window, during which maintenance might occur in hh:mm:ss format")
...
public class MaintenanceWindow {
   ...
   * @return time
  **/
  @ApiModelProperty(example = "16:30:59", required = true, value = "Time at which the maintenance should start. Must conform to the 'HH:MM:SS' 24-hour format.")
  ...
  public MaintenanceWindow dayOfTheWeek(DayOfTheWeekEnum dayOfTheWeek) {
   ...
   * @return dayOfTheWeek
  **/
  @ApiModelProperty(example = "Monday", required = true, value = "")
