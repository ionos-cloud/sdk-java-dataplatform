...
import com.ionoscloud.dataplatform.model.Metadata;
import com.ionoscloud.dataplatform.model.NodePool;
 ...
 * Data of a node pool
 */
@ApiModel(description = "Data of a node pool")
...
public class NodePoolResponseData {
  ...
  private NodePool properties;

  

  public NodePoolResponseData id(UUID id) {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The unique ID of the resource. Must conform to the UUID format. ")
  ...
  public NodePoolResponseData type(String type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "nodepool", value = "The type of the resource.")
  ...
  public NodePoolResponseData href(String href) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://api.ionos.com/dataplatform/v1/clusters/498ae72f-411f-11eb-9d07-046c59cc737e/nodepools/abcd7e2f-9876-1234-abcd-123459498ae7", value = "URL to the object representation (absolute path).")
  ...
  public NodePoolResponseData metadata(Metadata metadata) {
  ...
  **/
  ...
  public NodePoolResponseData properties(NodePool properties) {
  ...
  **/
  ...
  public NodePool getProperties() {
    return properties;
  }


  public void setProperties(NodePool properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(Object o) {
    ...
    NodePoolResponseData nodePoolResponseData = (NodePoolResponseData) o;
    return Objects.equals(this.id, nodePoolResponseData.id) && Objects.equals(this.type, nodePoolResponseData.type) && Objects.equals(this.href, nodePoolResponseData.href) && Objects.equals(this.metadata, nodePoolResponseData.metadata) && Objects.equals(this.properties, nodePoolResponseData.properties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodePoolResponseData {\n");
